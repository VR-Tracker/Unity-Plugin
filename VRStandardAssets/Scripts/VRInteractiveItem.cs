...
namespace VRStandardAssets.Utils
{
    ...
    public class VRInteractiveItem : MonoBehaviour
    {
        ...
        public event EventHandler OverEvent;
        public event EventHandler OutEvent;

        protected bool m_IsOver;

        protected virtual void OnOverEvent(EventArgs e)
        {
            EventHandler handler = OverEvent;
            if (handler != null)
            {
                handler(this, e);
            }
        ...
        protected virtual void OnOutEvent(EventArgs e)
        {
            EventHandler handler = OutEvent;
            if (handler != null)
            {
                handler(this, e);
            }
