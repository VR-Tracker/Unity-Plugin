...
namespace VRStandardAssets.Utils
{
    ...
    public class SelectionSlider : MonoBehaviour
    {
        ...
        private void Start ()
        {
            ...
            m_InteractiveItem.OverEvent += HandleOver;
            m_InteractiveItem.OutEvent += HandleOut;
        }
        ...
        private void HandleOver(object sender, EventArgs e)
        {
        ...
        private void HandleOut(object sender, EventArgs e)
        {
