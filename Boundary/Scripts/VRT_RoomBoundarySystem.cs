    ...
    public class VRT_RoomBoundarySystem : MonoBehaviour
    {
        ...
        void Update()
        {
            ...
            if (distance < distanceStartFade)
            {
                ...
                //Debug.Log("Update function distance from wall : " + distance + " alpha set to : " + closeToWallValue);

            }
            else if (generalAlpha != 0.0f)
            {
                //Debug.Log("Update function distance from wall : " + distance + " alpha set to zero ");
